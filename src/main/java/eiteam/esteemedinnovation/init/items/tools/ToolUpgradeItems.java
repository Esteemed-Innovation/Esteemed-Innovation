...
public class ToolUpgradeItems implements IInitCategory {
    public enum Items {
        ...
        OVERCLOCKER(new ItemOverclockerUpgrade(), "overclocker"),
        ...
        THERMAL_DRILL(SteamToolSlot.DRILL_HEAD, "thermal", null, 1, "thermal_drill"),
        MULTIPLICATIVE_RESONATOR(SteamToolSlot.DRILL_HEAD, "fortune", null, 1, "multiplicative_resonator"),
        CHARGE_PLACER(SteamToolSlot.DRILL_HEAD, "chargePlacer", null, 1, "charge_placer"),
        DRILL_HEAD(new ItemDrillHeadUpgrade(), "drill_head"),
        INTERNAL_PROCESSING_UNIT(SteamToolSlot.DRILL_CORE, "processor", null, 0, "internal_processing_unit"),
        LEAF_BLOWER(SteamToolSlot.SAW_HEAD, "blower", null, 1, "leaf_blower"),
        TIMBER_CHAIN(SteamToolSlot.SAW_HEAD, "timberHead", null, 1, "timber_chain"),
        CHAINSAW(SteamToolSlot.SAW_HEAD, "chain", null, 1, "chainsaw"),
        FOREST_FIRE(SteamToolSlot.SAW_HEAD, "fire", null, 1, "forest_fire"),
        CULTIVATOR(SteamToolSlot.SHOVEL_HEAD, "cultivatorHead", null, 1, "cultivator"),
        ROTARY_BLADES(SteamToolSlot.SHOVEL_HEAD, "rotary", null, 1, "rotary_blades"),
        SIFTER(SteamToolSlot.SHOVEL_CORE, "sifter", null, 0, "sifter"),
        BACKHOE(SteamToolSlot.SHOVEL_HEAD, "backhoe", null, 1, "backhoe");
        ...
        Items(SteamToolSlot slot, String resourceDir, String info, int prio, String name) {
            this(new ItemSteamToolUpgrade(slot, EsteemedInnovation.MOD_ID + ":items/toolUpgrades/" + resourceDir, info, prio), name);
        }

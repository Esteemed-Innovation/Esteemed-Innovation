...
public class MetalItems implements IInitCategory {
    public enum Items {
        ...
        public enum Types {
            ...
            PLATE(new ItemMetalPlate(), "plate");
    ...
    public void oreDict() {
        ...
        OreDictionary.registerOre(PLATE_THIN_COPPER, Items.COPPER_PLATE.createItemStack());
        OreDictionary.registerOre(PLATE_THIN_ZINC, Items.ZINC_PLATE.createItemStack());
        OreDictionary.registerOre(PLATE_THIN_BRASS, Items.BRASS_PLATE.createItemStack());
        OreDictionary.registerOre(PLATE_THIN_GILDED_IRON, Items.GILDED_IRON_PLATE.createItemStack());
        OreDictionary.registerOre(PLATE_THIN_IRON, Items.IRON_PLATE.createItemStack());
        OreDictionary.registerOre(PLATE_THIN_GOLD, Items.GOLD_PLATE.createItemStack());

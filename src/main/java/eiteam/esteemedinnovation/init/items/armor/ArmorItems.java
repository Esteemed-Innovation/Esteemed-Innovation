...
import eiteam.esteemedinnovation.item.armor.ItemGenericArmor;
import eiteam.esteemedinnovation.item.armor.ItemGoggles;
import eiteam.esteemedinnovation.item.armor.ItemTophat;

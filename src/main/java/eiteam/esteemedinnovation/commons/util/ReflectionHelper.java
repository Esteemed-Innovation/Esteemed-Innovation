...
public class ReflectionHelper {
    ...
    public static Field getField(String fieldName, String obfName, Class clazz) {
        ...
        try {
            ...
            EsteemedInnovation.logger.warn("Unable to find field " + fieldName + " with its obfuscated " +
    ...
    public static Method getMethod(String methodName, String obfName, Class clazz, Class<?>... params) {
        ...
        try {
            ...
            EsteemedInnovation.logger.warn("Unable to find method " + methodName + " with its obfuscated name. Trying to" +
            ...
            try {
                ...
                EsteemedInnovation.logger.warn("Unable to find " + methodName + " method in " + clazz.getName() +
    ...
    public static void init() {
        EsteemedInnovation.logger.info("Getting some fields through reflection.");
        ...
        try {
            ...
            EsteemedInnovation.logger.warn("GuiMerchant class not found. You are probably a server.");
        }
    }

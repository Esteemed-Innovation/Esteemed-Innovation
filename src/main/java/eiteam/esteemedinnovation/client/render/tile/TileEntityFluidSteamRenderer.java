...
import eiteam.esteemedinnovation.client.render.model.ModelFluidSteam;
...
public class TileEntityFluidSteamRenderer extends TileEntitySpecialRenderer implements IInventoryTESR {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(EsteemedInnovation.MOD_ID + ":textures/models/fluidSteam.png");

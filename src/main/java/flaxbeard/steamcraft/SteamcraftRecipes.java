...
//		}
	...
	private static void registerCraftingRecipes() {
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(SteamcraftBlocks.ruptureDisc, 1, 0), "plateZinc", new ItemStack(SteamcraftBlocks.ruptureDisc, 1, 1)));

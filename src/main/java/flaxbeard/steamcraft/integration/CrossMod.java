...
public class CrossMod{
	...
	public static final boolean ENDER_IO = Loader.isModLoaded("EnderIO") && Config.enableEnderIOIntegration;
	public static final boolean INDUSTRIALCRAFT = Loader.isModLoaded("IC2") && Config.enableIC2Integration;
	public static final boolean NATURA = Loader.isModLoaded("Natura") && Config.enableNaturaIntegration;
	public static final boolean RAILCRAFT = Loader.isModLoaded("Railcraft") && Config.enableRailcraftIntegration;
	public static final boolean THAUMCRAFT = Loader.isModLoaded("Thaumcraft") && Config.enableThaumcraftIntegration;
	public static final boolean THERMAL_FOUNDATION = Loader.isModLoaded("ThermalFoundation") && Config.enableThermalFoundationIntegration;
	public static final boolean TINKERS_CONSTRUCT = Loader.isModLoaded("TConstruct") && Config.enableTinkersConstruct;
	public static final boolean TWILIGHT_FOREST = Loader.isModLoaded("TwilightForest") && Config.enableTwilightForestIntegration;

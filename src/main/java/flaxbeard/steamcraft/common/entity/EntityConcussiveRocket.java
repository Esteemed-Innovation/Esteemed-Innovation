...
import flaxbeard.steamcraft.common.misc.ExplosionRocket;
...
public class EntityConcussiveRocket extends EntityRocket {
    ...
    public EntityConcussiveRocket(World p_i1759_1_) {
        super(p_i1759_1_);
    }

    public EntityConcussiveRocket(World p_i1761_1_,
    ...
    public Explosion newExplosion(World world, Entity p_72885_1_, double p_72885_2_, double p_72885_4_, double p_72885_6_, float p_72885_8_, boolean p_72885_9_, boolean p_72885_10_) {
        Explosion explosion = new ExplosionRocket(world, p_72885_1_, p_72885_2_, p_72885_4_, p_72885_6_, p_72885_8_, false);

package flaxbeard.steamcraft.common.codechicken.lib.render;

import flaxbeard.steamcraft.common.codechicken.lib.colour.ColourRGBA;
import flaxbeard.steamcraft.common.codechicken.lib.lighting.LC;
import flaxbeard.steamcraft.common.codechicken.lib.lighting.LightMatrix;
import flaxbeard.steamcraft.common.codechicken.lib.util.Copyable;
import flaxbeard.steamcraft.common.codechicken.lib.vec.Rotation;
import flaxbeard.steamcraft.common.codechicken.lib.vec.Transformation;
import flaxbeard.steamcraft.common.codechicken.lib.vec.Vector3;
...
public class CCRenderState {
    ...
    public static LightMatrix lightMatrix = new LightMatrix();    public static VertexAttribute<Vector3[]> normalAttrib = new VertexAttribute<Vector3[]>() {
    ...
    public static Vector3 normal = new Vector3();    public static VertexAttribute<int[]> sideAttrib = new VertexAttribute<int[]>() {
        private int[] sideRef;

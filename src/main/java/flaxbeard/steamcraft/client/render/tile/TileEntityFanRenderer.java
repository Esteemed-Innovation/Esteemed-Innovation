...
public class TileEntityFanRenderer extends TileEntitySpecialRenderer<TileEntityFan> {
    static final ResourceLocation BLADES_TEXTURE = new ResourceLocation(Steamcraft.MOD_ID, "textures/blocks/fan_blades_noise.png");
    static final ResourceLocation BLADES_RL = new ResourceLocation(Steamcraft.MOD_ID, "block/fan_blades");

...
public class TileEntityCrucibleRenderer extends TileEntitySpecialRenderer<TileEntityCrucible> {
    ...
    private void renderLiquid(TileEntityCrucible crucible) {
        ...
        buffer.pos(0.125D, 0, 0.125D).tex(f1, f4).color(liquid.cr, liquid.cg, liquid.cb, 255).endVertex();
        buffer.pos(0.875D, 0, 0.125D).tex(f3, f4).color(liquid.cr, liquid.cg, liquid.cb, 255).endVertex();
        buffer.pos(0.875D, 0, 0.875D).tex(f3, f2).color(liquid.cr, liquid.cg, liquid.cb, 255).endVertex();
        buffer.pos(0.125D, 0, 0.875D).tex(f1, f2).color(liquid.cr, liquid.cg, liquid.cb, 255).endVertex();
        tessellator.draw();
    }
}
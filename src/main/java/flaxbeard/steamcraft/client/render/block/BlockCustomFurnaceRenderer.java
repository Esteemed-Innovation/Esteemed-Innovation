...
import flaxbeard.steamcraft.common.block.BlockCustomFurnace;
import flaxbeard.steamcraft.common.misc.BlockContainer;
import flaxbeard.steamcraft.common.misc.WorldContainer;
import flaxbeard.steamcraft.common.tile.TileEntityCustomFurnace;
...
public class BlockCustomFurnaceRenderer implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
        ...
        if (BlockSteamPipeRenderer.updateWrenchStatus() || (boiler.disguiseBlock == null || boiler.disguiseBlock == Blocks.air)) {
            ...
            ren2 = null;
            con = null;
            IIcon icon = block == SteamcraftBlocks.customFurnace ? ((BlockCustomFurnace) block).camoOnIcon : ((BlockCustomFurnace) block).camoIcon;

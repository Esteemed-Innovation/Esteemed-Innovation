...
import flaxbeard.steamcraft.common.item.*;
import flaxbeard.steamcraft.common.item.exosuit.*;
import flaxbeard.steamcraft.common.item.firearm.*;
import flaxbeard.steamcraft.common.item.tool.*;

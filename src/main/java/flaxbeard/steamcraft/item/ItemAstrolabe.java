        ...
        if (item.hasTagCompound()) {
            ...
            if (nbt.hasKey("targetX")) {
                ...
                switch (dim) {
                    ...
                    default: {
                        dimension = I18n.format("steamcraft.astrolabe.dimension") + " " + dim;
                        break;
                    }
                }
                tooltip.add(I18n.format("steamcraft.astrolabe.target") + " " + x + ", " + z + " " + I18n.format("steamcraft.astrolabe.in") + " " + dimension);
                return;
            }
        }
        tooltip.add(I18n.format("steamcraft.astrolabe.noTarget"));
    }

...
public class ArmorModule extends ContentModule implements ConfigurableModule {
    ...
    private static final double EXTENDED_RANGE_DEFAULT = 2.0;
    ...
    public static double extendedRange; //Range extension in blocks
    ...
    public void loadConfigurationOptions(Configuration config) {
        ...
        extendedRange = config.get(CATEGORY_EXOSUIT_UPGRADES, "The distance the ExtendoFist upgrade boosts", EXTENDED_RANGE_DEFAULT).getDouble();
